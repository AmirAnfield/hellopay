...
import { Book, Calculator, Database, CodeIcon } from "lucide-react";
    ...
    <div className="container py-10">
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold tracking-tight">Guide de la paie</h1>
          <p className="text-muted-foreground">
            Comprendre les principes et mécanismes du calcul des bulletins de paie en France
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <Card className="lg:col-span-3">
            ...
            <CardContent className="prose max-w-none prose-headings:mb-4 prose-headings:mt-6 prose-p:mt-3 prose-p:leading-7">
              {activeTab === "introduction" && (
                <>
              ...
              {activeTab === "calcul" && (
                <>
                  ...
                  <pre>Net imposable = Salaire brut - Cotisations salariales (hors CSG/CRDS non déductible)</pre>
                  
                  <h3>4. Calcul du net à payer avant impôt</h3>
                  <p>Le net à payer avant impôt correspond à :</p>
                  <pre>Net à payer avant impôt = Salaire brut - Toutes les cotisations salariales</pre>
                  ...
                  <pre>Montant prélevé = Net imposable × Taux personnalisé</pre>
                  
                  <h3>6. Calcul du net à payer</h3>
                  <p>Le montant final versé au salarié est :</p>
                  <pre>Net à payer = Net à payer avant impôt - Prélèvement à la source + Remboursements de frais éventuels</pre>
                </>
              )}
