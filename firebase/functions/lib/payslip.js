...
exports.generatePayslipPdf = exports.calculatePayslip = void 0;
 ...
 */
exports.calculatePayslip = (0, https_1.onCall)({
    region: 'europe-west1'
}, async (request) => {
    ...
    try {
        ...
        const rates = JSON.parse(ratesData.ratesJson || '[]');
        // Calculer le salaire brut
        const hourlyRate = data.payslipData.hourlyRate || (employee === null || employee === void 0 ? void 0 : employee.hourlyRate) || 0;
        ...
        const payslip = {
            ...
            status: 'draft',
            employerName: (company === null || company === void 0 ? void 0 : company.name) || '',
            employerAddress: company ? `${company.address}, ${company.postalCode} ${company.city}` : '',
            employerSiret: (company === null || company === void 0 ? void 0 : company.siret) || '',
            employerUrssaf: (company === null || company === void 0 ? void 0 : company.urssafNumber) || '',
            employeeName: employee ? `${employee.firstName} ${employee.lastName}` : '',
            employeeAddress: employee ? `${employee.address}, ${employee.postalCode} ${employee.city}` : '',
            employeePosition: (employee === null || employee === void 0 ? void 0 : employee.position) || '',
            employeeSocialSecurityNumber: (employee === null || employee === void 0 ? void 0 : employee.socialSecurityNumber) || '',
            isExecutive: (employee === null || employee === void 0 ? void 0 : employee.isExecutive) || false,
 ...
 */
exports.generatePayslipPdf = (0, https_1.onCall)({
    region: 'europe-west1',
    timeoutSeconds: 300,
    memory: '1GiB',
}, async (request) => {
 ...
 */
function calculateContributions(grossSalary, rates) {
    const contributions = [];
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <div class="subtitle">Période du ${formatDate(payslip.periodStart)} au ${formatDate(payslip.periodEnd)}</div>
        </div>
